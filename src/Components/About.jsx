                ...
                <div className='container'>
                    <div className='row align-items-center'>
                        ...
                        <div className='col-md-6'>
                            <div className=''>
                                <h3>About Me</h3>
                                <h5> Java FullStack Developer</h5>
                                <p>I am a skilled Web Developer with a passion for creating dynamic and user-friendly websites. Proficient in <mark><b>HTML, CSS, JavaScript, Bootstrap and ReactJS</b></mark>, I craft visually appealing and responsive web pages. My expertise extends to backend development with <mark><b>Java, Spring Boot and SQL(MySql)</b></mark> enabling robust database management and server-side functionality. Additionally, I leverage React for building interactive and seamless user interfaces. My proficiency in Git ensures efficient version control and collaborative development. With a strong commitment to staying updated with the latest industry trends, I strive to deliver exceptional digital experiences.</p>
                                <hr />
                                <ul class="list-inline about-info">
                                    ...
                                    <li> <span>Designation :</span> <p> Java Developer {'</>'}</p> </li>
                                ...
                                <Link  className='banner-btn btn-color' to="webdeveloepr.pdf" target="_blank" download>Resume</Link>
